// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.13.0-134.0.dev.
...
(function dartProgram() {
  ...
  J = {
    ...
    animate$2$x: function(receiver, a0, a1) {
  ...
  P = {
    ...
    StringBuffer__writeAll: function(string, objects, separator) {
      ...
      if (separator.length === 0) {
        do
          string += H.S(iterator.__interceptors$_current);
        while (iterator.moveNext$0());
      } else {
        string += H.S(iterator.__interceptors$_current);
        for (; iterator.moveNext$0();)
          string = string + separator + H.S(iterator.__interceptors$_current);
      }
      return string;
    },
    ...
    _convertDartToNative_Value: function(value) {
      ...
      if (type$.Map_dynamic_dynamic._is(value))
        return P.convertDartToNative_Dictionary(value, null);
      if (type$.List_dynamic._is(value)) {
        array = [];
        C.JSArray_methods.forEach$1(value, new P._convertDartToNative_Value_closure(array));
        value = array;
      }
      return value;
    },
    convertDartToNative_Dictionary: function(dict, postCreate) {
      var object;
      type$.nullable_Map_dynamic_dynamic._as(dict);
      type$.nullable_void_Function_nullable_Object._as(postCreate);
      if (dict == null)
        return null;
      object = {};
      if (postCreate != null)
  ...
  B = {
    main: function(args) {
      var t6, x, t1 = {},
        ...
        t3 = type$.dynamic,
        t4 = P.LinkedHashMap_LinkedHashMap$_literal(["transform", "translate(0%, 0%)"], t2, t3),
        t5 = window.screen.width;
      if (typeof t5 !== "number")
        return t5.$sub();
      t5 = "translate(" + (t5 - 50) + "px, ";
      t6 = window.screen.height;
      if (typeof t6 !== "number")
        return t6.$sub();
      x = t1.x = H.setRuntimeTypeInfo([t4, P.LinkedHashMap_LinkedHashMap$_literal(["transform", t5 + (t6 - 50) + "px)"], t2, t3)], type$.JSArray_legacy_Map_of_legacy_String_and_dynamic);
      J.animate$2$x(document.querySelector("#move"), x, 5000);
      t3 = C.JSArray_methods.toList$0(x);
      t1.x = new H.ReversedListIterable(t3, H._arrayInstanceType(t3)._eval$1("ReversedListIterable<1>"));
      P.Timer_Timer$periodic(new P.Duration(5000000), new B.main_closure(t1));
    },
  ...
  H.ListIterator.prototype = {
    ...
    moveNext$0: function() {
      ...
      _this.set$_current(t1.elementAt$1(0, t2));
      ++_this._index;
      return true;
    },
  ...
  W.Element.prototype = {
    animate$2: function(receiver, $frames, timing) {
      var t1, t2, convertedFrames;
      type$.Iterable_Map_String_dynamic._as($frames);
      t1 = J.getInterceptor$a($frames);
      t2 = t1.every$1($frames, new W.Element_animate_closure());
      if (!t2)
        throw H.wrapException(P.ArgumentError$("The frames parameter should be a List of Maps with frame information"));
      t1 = t1.map$1$1($frames, P.html_common__convertDartToNative_Dictionary$closure(), type$.dynamic);
      convertedFrames = P.List_List$of(t1, true, t1.$ti._eval$1("ListIterable.E"));
      return receiver.animate(convertedFrames, timing);
    },
    toString$0: function(receiver) {
  ...
  W.Element_animate_closure.prototype = {
    call$1: function(x) {
      return type$.Map_dynamic_dynamic._is(type$.Map_String_dynamic._as(x));
    },
    $signature: 10
  };
  ...
  B.main_closure.prototype = {
    call$1: function(t) {
      var t2,
        t1 = this._box_0;
      J.animate$2$x(document.querySelector("#move"), t1.x, 5000);
      t2 = J.toList$0$a(t1.x);
      t1.x = new H.ReversedListIterable(t2, H._arrayInstanceType(t2)._eval$1("ReversedListIterable<1>"));
    },
    $signature: 13
  };
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(P, "html_common__convertDartToNative_Dictionary$closure", 1, null, ["call$2", "call$1"], ["convertDartToNative_Dictionary", function(dict) {
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, P.Iterable, H.ListIterator, H.TypeErrorDecoder, H.NullThrownFromJavaScriptException, H._StackTrace, H.Closure, P.MapMixin, H.LinkedHashMapCell, H.Rti, H._FunctionParameters, P._TimerImpl, P._AsyncCallbackEntry, P._Zone, P.Duration, P.StackOverflowError, P._Exception, P.Null, P.StringBuffer]);
    ...
    _inheritMany(H.Closure, [H.TearOffClosure, H.initHooks_closure, H.initHooks_closure0, H.initHooks_closure1, P._AsyncRun__initializeScheduleImmediate_internalCallback, P._AsyncRun__initializeScheduleImmediate_closure, P._AsyncRun__scheduleImmediateJsOverride_internalCallback, P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback, P._TimerImpl_internalCallback, P._TimerImpl$periodic_closure, P._rootHandleUncaughtError_closure, P._RootZone_bindUnaryCallbackGuarded_closure, P.MapBase_mapToString_closure, P.Duration_toString_sixDigits, P.Duration_toString_twoDigits, W.Element_animate_closure, P._convertDartToNative_Value_closure, P.convertDartToNative_Dictionary_closure, B.main_closure]);
  ...
  var init = {
    ...
    metadata: [],
    types: ["Null()", "~()", "~(~())", "String(int)", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "~(Object?,Object?)", "bool(Map<String,@>)", "~(@)", "~(@,@)", "Null(Timer*)", "@(Map<@,@>?[~(Object?)?])"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: typeof Symbol == "function" && typeof Symbol() == "symbol" ? Symbol("$ti") : "$ti"
  };
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"JavaScriptObject","UnknownJavaScriptObject":"JavaScriptObject","JavaScriptFunction":"JavaScriptObject","JSBool":{"bool":[]},"JavaScriptObject":{"Function":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2"},"ReversedListIterable":{"ListIterable":["1"],"Iterable":["1"],"ListIterable.E":"1"},"NullError":{"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"LinkedHashMap":["1","2"],"Map":["1","2"]},"_Error":{"Error":[]},"_TypeError":{"Error":[]},"_TimerImpl":{"Timer":[]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]}}'));
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      Iterable_Map_String_dynamic: findType("Iterable<Map<String,@>>"),
      ...
      nullable_void_Function_nullable_Object: findType("~(Object?)?"),
      num: findType("num"),
      void: findType("~"),
...
;
  ...
  (function(callback) {
    ...
    var callMain = function(args) {
      return B.main(H.convertMainArgumentList(args));
    };
...
//# sourceMappingURL=SomeOtherPage.dart.js.map
